...
async function handleOnLoad() {
    ...
    // let bestResult;
    // let bestMinDeltaViprRating;
    // let worstResult;
    // let worstMaxDeltaViprRating;
    ...
    const response = await fetch("data/ViprAlgoResults" + groupId + ".json");
    ...
    gameResults.forEach((gr) => {
        ...
        if ( playerLabel && (gr.winner != "tie")) {
          ...
          // if (minDeltaViprRating >= playerTeamCombinedDeltaRating) {
          //   minDeltaViprRating = playerTeamCombinedDeltaRating;
          //   if (gr.winner == teamLabel) {
          //     bestResult = gr; // The game with the lowest delta VIPR rating that you won
          //     bestMinDeltaViprRating = playerTeamCombinedDeltaRating;
          //   }
          // }

          // if (maxDeltaViprRating <= playerTeamCombinedDeltaRating) {
          //   maxDeltaViprRating = playerTeamCombinedDeltaRating          
          //   if (gr.loser == teamLabel) {
          //     worstResult = gr; // The game with the highest delta VIPR rating that you lost
          //     worstMaxDeltaViprRating = playerTeamCombinedDeltaRating;      
          //   }
          // }
...
<div class="highlite-message" style="font-size: 24px; margin-top: 8px;">Best Game:</div>
<div class="highlite-message">${bestGameMessage}</div>
<div class="highlite-message" style="font-size: 24px; margin-top: 8px;">Worst Game:</div>
<div class="highlite-message">${worstGameMessage}</div>
`;
